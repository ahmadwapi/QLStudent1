...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        self.obstacle1 = self.canvas_widget.create_image(pixels * 4, pixels * 2, anchor='nw', image=self.obstacle2_object)
        # Obstacle 2
        self.obstacle2 = self.canvas_widget.create_image(0, pixels * 1, anchor='nw', image=self.obstacle6_object)
        # Obstacle 3
        self.obstacle3 = self.canvas_widget.create_image(pixels * 1, pixels * 8, anchor='nw', image=self.obstacle5_object)
        # Obstacle 4
        self.obstacle4 = self.canvas_widget.create_image(pixels * 3, pixels * 2, anchor='nw', image=self.obstacle2_object)
        # Obstacle 5
        self.obstacle5 = self.canvas_widget.create_image(pixels * 3, pixels, anchor='nw', image=self.obstacle12_object)
        # Obstacle 6
        self.obstacle6 = self.canvas_widget.create_image(pixels * 5, pixels * 2, anchor='nw', image=self.obstacle7_object)
        # Obstacle 7
        ...
        # Obstacle 13
        self.obstacle13 = self.canvas_widget.create_image(pixels * 8, pixels * 7, anchor='nw', image=self.obstacle3_object)
        # Obstacle 14
        self.obstacle14 = self.canvas_widget.create_image(pixels * 2, pixels * 5, anchor='nw', image=self.obstacle8_object)
        # Obstacle 15
        ...
        # Obstacle 18
        self.obstacle18 = self.canvas_widget.create_image(pixels * 3, pixels * 6, anchor='nw', image=self.obstacle11_object)
        # Obstacle 19
        self.obstacle19 = self.canvas_widget.create_image(pixels * 8, pixels * 3, anchor='nw', image=self.obstacle8_object)
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(pixels * 8, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 21
        ...
        self.agent = self.canvas_widget.create_image(pixels * 4, pixels * 2, anchor='nw', image=self.robot)
